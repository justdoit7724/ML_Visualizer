...
namespace DX {
	...
	namespace Geometrics {
		...
		bool  IntersectInPlaneSphere(PlaneInf plane, Sphere sph);
		// infinite ray
		bool  IntersectRaySphere(Ray ray, Sphere sph);
		bool  IntersectRayPlaneInf(const Ray ray, const PlaneInf plane, DirectX::XMFLOAT3* itsPt);
		// considered infinite ray & both plane side
		bool  IntersectRayPlane(Ray ray, Plane plane, DirectX::XMFLOAT3* itsPt);
		bool  Intersect2DRayLine(Ray2D ray, DirectX::XMFLOAT2 linePt1, DirectX::XMFLOAT2 linePt2);
	}
}
